		...
		<view v-for="(item ,index) in datalist" :key="index" class="sale-list bf mt5">
			...
			<view class="item2">
				...
				<view class="right">
					...
					<view class="state type01" v-if="item.tx_api_state==1">已转账</view>
					<view class="state type02" v-if="item.tx_api_state==0">未转账</view>
				</view>
			</view>
			<view v-if="item.tx_error">{{item.tx_error}}</view>
		</view>
